...
!function(t, e) {
    ...
    var n = {
        ...
        createWidgetType: function(e, i, o) {
            ...
            return r.types = r.types.concat([e]),
            t.extend(r, i),
            r.constructor = s,
    ...
    n.Widget = function(e) {
        var i = this
          ...
          , d = function(e) {
            if (!g(e)) {
                if (o.hide.onClick) {
                    if (t(e.target).closest(o.selectors.preventClose).length)
                        return
          ...
          , l = function(e) {
            g(e) || t(e.target).closest(r.widget).length || function(e) {
          ...
          , f = function() {
            t.each(o, (function(t) {
                ...
                e && (e = e[1].charAt(0).toLowerCase() + e[1].slice(1),
                i.on(e, this))
            }
            ))
        }
          ...
          , p = function() {
            ...
            t.forEach((function(t) {
                ...
                o.hide.onOutsideClick && t[0].removeEventListener("click", l, !0),
                o.hide.onOutsideContextMenu && t[0].removeEventListener("contextmenu", l, !0),
                o.position.autoRefresh && t.off("resize", i.refreshPosition)
            }
            )),
            (o.hide.onClick || o.hide.onBackgroundClick) && r.widget.off("click", d)
        };
        ...
        this.hide = function() {
            if (i.isVisible())
                ...
                u("hide", arguments),
                p(),
                o.preventScroll && i.getElements("body").removeClass(o.classes.preventScroll),
                i.trigger("hide"),
                i
        }
        ,
        this.init = function(s, a) {
            if (!(s instanceof n.Instance))
                throw "The " + i.widgetName + " must to be initialized from an instance of DialogsManager.Instance";
            var u;
            return u = c.concat(i.getClosureMethods()),
            t.each(u, (function() {
                var t = i[this];
                i[this] = function() {
                    t.apply(i, arguments)
                ...
                o.iframe && function(t) {
                    if (t.my) {
                        var e = /([+-]\d+)?$/
                          ...
                          , o = t.my.split(" ")
                          , s = [];
                        1 === o.length && (/left|right/.test(o[0]) ? o.push("center") : o.unshift("center")),
                        o.forEach((function(t, o) {
                            var r = t.replace(e, (function(t) {
                                return t = +t || 0,
                                (t += o ? n.top - i.scrollY : n.left - i.scrollX) >= 0 && (t = "+" + t),
                                t
                            }
                            ));
                            s.push(r)
        ...
        this.setID = function(t) {
            return r.widget.attr("id", t),
            i
        }
        ,
        this.setHeaderMessage = function(t) {
            return i.getElements("header").html(t),
            i
        }
        ,
        this.setMessage = function(t) {
            return r.message.html(t),
            i
        }
        ,
        this.setSettings = function(e, n) {
            return jQuery.isPlainObject(n) ? t.extend(!0, o[e], n) : o[e] = n,
            i
        }
        ,
        this.show = function() {
            ...
            t.forEach((function(t) {
                ...
                o.hide.onOutsideContextMenu && t[0].addEventListener("contextmenu", l, !0),
                o.position.autoRefresh && t.on("resize", i.refreshPosition)
            }
            )),
            (o.hide.onClick || o.hide.onBackgroundClick) && r.widget.on("click", d),
            o.preventScroll && i.getElements("body").addClass(o.classes.preventScroll),
            i.trigger("show"),
            i
        }
        ,
        ...
        activeKeyDown: function(t) {
            if (this.focusedButton) {
                if (9 === t.which) {
                    ...
                    t.shiftKey ? (e = n - 1) < 0 && (e = this.buttons.length - 1) : (e = n + 1) >= this.buttons.length && (e = 0),
