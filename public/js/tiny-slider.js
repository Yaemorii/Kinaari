    ...
    var R = function(t) {
        ...
        if (B) {
            var S = navigator.userAgent
              , H = new Date;
            try {
                (b = l.localStorage) ? (b.setItem(H, H),
                B = b.getItem(H) == H,
                b.removeItem(H)) : B = !1,
                B || (b = {})
            } catch (S) {
        ...
        var I = b.tC ? r(b.tC) : o(b, "tC", function() {
          ...
          , z = b.tMQ ? r(b.tMQ) : o(b, "tMQ", function() {
            if (window.matchMedia || window.msMatchMedia)
                return !0;
            var t, e = document, n = u(), i = s(n), a = e.createElement("div"), r = e.createElement("style"), o = "@media all and (min-width:1px){.tns-mq-test{position:absolute}}";
          ...
          , q = b.t3D ? r(b.t3D) : o(b, "t3D", function(t) {
            if (!t)
                return !1;
        ...
        !(t.container.children.length < 1)) {
            ...
            var ot, ut, lt = "horizontal" === t.axis, st = n.createElement("div"), ct = n.createElement("div"), ft = t.container, dt = ft.parentNode, vt = ft.outerHTML, pt = ft.children, ht = pt.length, mt = On(), yt = !1;
            U && Zn(),
            Z && (ft.className += " tns-vpfix");
            var gt, xt, bt, wt, Ct, Mt, Tt, Et, At = t.autoWidth, Nt = In("fixedWidth"), Lt = In("edgePadding"), Bt = In("gutter"), St = kn(), Ht = In("center"), Ot = At ? 1 : Math.floor(In("items")), Dt = In("slideBy"), kt = t.viewportMax || t.fixedWidthViewportWidth, Rt = In("arrowKeys"), It = In("speed"), Pt = t.rewind, zt = !Pt && t.loop, Wt = In("autoHeight"), qt = In("controls"), Ft = In("controlsText"), jt = In("nav"), Vt = In("touch"), Gt = In("mouseDrag"), Qt = In("autoplay"), Xt = In("autoplayTimeout"), Yt = In("autoplayText"), Kt = In("autoplayHoverPause"), Jt = In("autoplayResetOnVisibility"), Ut = (Tt = In("nonce"),
            Et = document.createElement("style"),
            Tt && Et.setAttribute("nonce", Tt),
            document.querySelector("head").appendChild(Et),
            Et.sheet ? Et.sheet : Et.styleSheet), _t = t.lazyload, Zt = t.lazyloadSelector, $t = [], te = zt ? (Ct = function() {
                if (At || Nt && !kt)
                    return ht - 1;
                var e = Nt ? "fixedWidth" : "items"
                  , n = [];
                if ((Nt || t[e] < ht) && n.push(t[e]),
                U)
                    for (var i in U) {
                        var a = U[i][e];
                        a && (Nt || a < ht) && n.push(a)
                ...
                Math.ceil(Nt ? kt / Math.min.apply(null, n) : Math.max.apply(null, n))
            }(),
            Mt = Z ? Math.ceil((5 * Ct - ht) / 2) : 4 * Ct - ht,
            Mt = Math.max(Ct, Mt),
            Rn("edgePadding") ? Mt + 1 : Mt) : 0, ee = Z ? ht + 2 * te : ht + te, ne = !(!Nt && !At || zt), ie = Nt ? Ti() : null, ae = !Z || !zt, re = lt ? "left" : "top", oe = "", ue = "", le = Nt ? function() {
            ...
            : function() {
                return Ht && Z && !zt ? ht - 1 : zt || Z ? Math.max(0, ee - Math.ceil(Ot)) : ee - 1
            }
            , se = Bn(In("startIndex")), ce = se, fe = (Ln(),
            0), de = At ? null : le(), ve = t.preventActionWhenRunning, pe = t.swipeAngle, he = !pe || "?", me = !1, ye = t.onInit, ge = new k, xe = " tns-slider tns-" + t.mode, be = ft.id || (wt = window.tnsId,
            window.tnsId = wt ? wt + 1 : 1,
            "tns" + window.tnsId), we = In("disable"), Ce = !1, Me = t.freezable, Te = !(!Me || At) && _n(), Ee = !1, Ae = {
                click: Di,
                keydown: function(t) {
                    t = Fi(t);
                    var e = [p.LEFT, p.RIGHT].indexOf(t.keyCode);
                    0 <= e && (0 === e ? Ke.disabled || Di(t, -1) : Je.disabled || Di(t, 1))
                }
            }, Ne = {
                click: function(t) {
                    if (me) {
                ...
                keydown: function(t) {
                    ...
                    if (g(e, "data-nav")) {
                        ...
                        0 <= i && (0 === i ? 0 < a && qi(Ze[a - 1]) : 1 === i ? a < en - 1 && qi(Ze[a + 1]) : Oi(an = a, t))
                    }
                }
            }, Le = {
                mouseover: function() {
                ...
                mouseup: Ki,
                mouseleave: Ki
            }, De = Rn("controls"), ke = Rn("nav"), Re = !!At || t.navAsThumbnails, Ie = Rn("autoplay"), Pe = Rn("touch"), ze = Rn("mouseDrag"), We = "tns-slide-active", qe = "tns-slide-cloned", Fe = "tns-complete", je = {
                load: function(t) {
                    ui(ji(t))
                },
                error: function(t) {
            ...
            if (De)
                var Ge, Qe, Xe = t.controlsContainer, Ye = t.controlsContainer ? t.controlsContainer.outerHTML : "", Ke = t.prevButton, Je = t.nextButton, Ue = t.prevButton ? t.prevButton.outerHTML : "", _e = t.nextButton ? t.nextButton.outerHTML : "";
            if (ke)
                var Ze, $e = t.navContainer, tn = t.navContainer ? t.navContainer.outerHTML : "", en = At ? ht : Ui(), nn = 0, an = -1, rn = Hn(), on = rn, un = "tns-nav-active", ln = "Carousel Page ", sn = " (Current Slide)";
            if (Ie)
                var cn, fn, dn, vn, pn, hn = "forward" === t.autoplayDirection ? 1 : -1, mn = t.autoplayButton, yn = t.autoplayButton ? t.autoplayButton.outerHTML : "", gn = ["<span class='tns-visually-hidden'>", " animation</span>"];
            if (Pe || ze)
                var xn, bn, wn = {}, Cn = {}, Mn = !1, Tn = lt ? function(t, e) {
                    return t.x - e.x
                }
                : function(t, e) {
                    return t.y - e.y
            ...
            function() {
                ...
                xe += " tns-" + t.axis,
                ft.className += xe,
                Z ? ((ot = n.createElement("div")).id = be + "-mw",
                ...
                te) {
                    for (var e = n.createDocumentFragment(), i = n.createDocumentFragment(), a = te; a--; ) {
                        var r = a % ht
                          , o = pt[r].cloneNode(!0);
                        if (m(o, qe),
                        C(o, "id"),
            ...
            function() {
                if (!Z)
                    for (var e = se, n = se + Math.min(ht, Ot); e < n; e++) {
                        var i = pt[e];
                        i.style.left = 100 * (e - se) / Ot + "%",
                        m(i, nt),
                        y(i, rt)
                    }
                if (lt && (P || At ? (f(Ut, "#" + be + " > .tns-item", "font-size:" + l.getComputedStyle(pt[0]).fontSize + ";", d(Ut)),
                f(Ut, "#" + be, "font-size:0;", d(Ut))) : Z && v(pt, (function(t, e) {
                    var n;
                    t.style.marginLeft = (n = e,
                    I ? I + "(" + 100 * n + "% / " + ee + ")" : 100 * n / ee + "%")
                }
                ))),
                z) {
                    if (F) {
                    ...
                    a = Pn(t.edgePadding, t.gutter, t.fixedWidth, t.speed, t.autoHeight),
                    f(Ut, "#" + be + "-iw", a, d(Ut)),
                    Z && (a = lt && !At ? "width:" + zn(t.fixedWidth, t.gutter, t.items) + ";" : "",
                    F && (a += jn(It)),
                    f(Ut, "#" + be, a, d(Ut))),
                ...
                if (U && z)
                    for (var r in U) {
                        ...
                        "")
                          ...
                          , w = In("autoHeight", r)
                          , C = In("gutter", r);
                        F && ot && In("autoHeight", r) && "speed"in o && (u = "#" + be + "-mw{" + jn(x) + "}"),
                        ("edgePadding"in o || "gutter"in o) && (s = "#" + be + "-iw{" + Pn(b, C, g, x, w) + "}"),
                        Z && lt && !At && ("fixedWidth"in o || "items"in o || Nt && "gutter"in o) && (c = "width:" + zn(g, C, h) + ";"),
                        F && "speed"in o && (c += jn(x)),
                        c && (c = "#" + be + "{" + c + "}"),
                        ("fixedWidth"in o || Nt && "gutter"in o || !Z && "items"in o) && (p += Wn(g, C, h)),
                        "gutter"in o && (p += qn(C)),
                        !Z && "speed"in o && (F && (p += jn(x)),
                        V && (p += Vn(x))),
                        p && (p = "#" + be + " > .tns-item{" + p + "}"),
                        (a = u + s + c + p) && Ut.insertRule("@media (min-width: " + r / 16 + "em) {" + a + "}", Ut.cssRules.length)
                    }
            }(),
            Gn();
            var En = zt ? Z ? function() {
                var t = fe
                  , e = de;
                t += Dt,
                e -= Dt,
                Lt ? (t += 1,
                e -= 1) : Nt && (St + Bt) % (Nt + Bt) && (e -= 1),
            ...
            return {
                ...
                destroy: function() {
                    ...
                    K = nt = it = at = rt = lt = st = ct = ft = dt = vt = pt = ht = ut = mt = At = Nt = Lt = Bt = St = Ot = Dt = kt = Rt = It = Pt = zt = Wt = Ut = _t = gt = $t = te = ee = ne = ie = ae = re = oe = ue = le = se = ce = fe = de = pe = he = me = ye = ge = xe = be = we = Ce = Me = Te = Ee = Ae = Ne = Le = Be = Se = He = Oe = De = ke = Re = Ie = Pe = ze = We = Fe = je = xt = qt = Ft = Xe = Ye = Ke = Je = Ge = Qe = jt = $e = tn = Ze = en = nn = an = rn = on = un = ln = sn = Qt = Xt = hn = Yt = Kt = mn = yn = Jt = gn = cn = fn = dn = vn = pn = wn = Cn = xn = Mn = bn = Tn = Vt = Gt = null,
                    this)
        ...
        function Ln() {
            for (var t = Z ? se - te : se; t < 0; )
                t += ht;
            return t % ht + 1
        }
        function Bn(t) {
            return t = t ? Math.max(0, Math.min(zt ? ht - 1 : ht - Ot, t)) : 0,
            Z ? t + te : t
        }
        function Sn(t) {
            for (null == t && (t = se),
        ...
        function Hn() {
            var t, e = Sn();
            return t = Re ? e : Nt || At ? Math.ceil((e + 1) * en / ht - 1) : Math.floor(e / Ot),
            !zt && Z && se === de && (t = en - 1),
            t
        }
        function On() {
        ...
        function In(e, n) {
            ...
            return "slideBy" === e && "page" === i && (i = In("items")),
        ...
        function Gn() {
            if (Rn("autoHeight") || At || !lt) {
                ...
                v(t, (function(t) {
                    var e = t.src;
                    _t || (e && e.indexOf("data:image") < 0 ? (t.src = "",
                    O(t, je),
                    m(t, "loading"),
                    t.src = e) : ui(t))
                }
        ...
        function Yn() {
            if (mi(),
            st.insertAdjacentHTML("afterbegin", '<div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span class="current">' + ai() + "</span>  of " + ht + "</div>"),
            bt = st.querySelector(".tns-liveregion .current"),
            Ie) {
                var e = Qt ? "stop" : "start";
                mn ? w(mn, {
                    "data-action": e
                }) : t.autoplayButtonOutput && (st.insertAdjacentHTML(Dn(t.autoplayPosition), '<button type="button" data-action="' + e + '">' + gn[0] + e + gn[1] + Yt[0] + "</button>"),
            ...
            if (ke) {
                if ($e)
                    ...
                    for (var n = "", i = Re ? "" : 'style="display:none"', a = 0; a < ht; a++)
                        n += '<button type="button" data-nav="' + a + '" tabindex="-1" aria-controls="' + be + '" ' + i + ' aria-label="' + ln + (a + 1) + '"></button>';
                ...
                w(Ze[rn], {
                    "aria-label": ln + (rn + 1) + sn
                }),
                C(Ze[rn], "tabindex"),
                m(Ze[rn], un),
                O($e, Ne)
            }
            De && (Xe || Ke && Je || (st.insertAdjacentHTML(Dn(t.controlsPosition), '<div class="tns-controls" aria-label="Carousel Navigation" tabindex="0"><button type="button" data-controls="prev" tabindex="-1" aria-controls="' + be + '">' + Ft[0] + '</button><button type="button" data-controls="next" tabindex="-1" aria-controls="' + be + '">' + Ft[1] + "</button></div>"),
            Xe = st.querySelector(".tns-controls")),
            Ke && Je || (Ke = Xe.children[0],
            Je = Xe.children[1]),
            t.controlsContainer && w(Xe, {
                "aria-label": "Carousel Navigation",
                tabindex: "0"
            }),
            (t.controlsContainer || t.prevButton && t.nextButton) && w([Ke, Je], {
                "aria-controls": be,
                tabindex: "-1"
            }),
            (t.controlsContainer || t.prevButton && t.nextButton) && (w(Ke, {
                "data-controls": "prev"
            }),
            w(Je, {
                "data-controls": "next"
        ...
        function Kn() {
            ...
            Gt && O(ft, Oe),
            Rt && O(n, Se),
            "inner" === _ ? ge.on("outerResized", (function() {
                Un(),
                ge.emit("innerLoaded", Zi())
            }
            )) : (U || Nt || At || Wt || !lt) && O(l, {
                resize: Jn
            }),
        ...
        function Un(e) {
            if (yt) {
                "outer" === _ && ge.emit("outerResized", Zi(e)),
                mt = On();
                var i, a = ut, r = !1;
                U && (Zn(),
                (i = a !== ut) && ge.emit("newBreakpointStart", Zi(e)));
                var o, u, l, s, c = Ot, p = we, h = Te, g = Rt, x = qt, b = jt, w = Vt, C = Gt, M = Qt, A = Kt, N = Jt, L = se;
                if (i) {
                    var B = Nt
                      , S = Wt
                      , H = Ft
                ...
                Me && (i || Nt || At) && (Te = _n()) !== h && (Te ? (Ni(Ei(Bn(0))),
                ei()) : (function() {
                    if (Ee) {
                        if (Lt && z && (ct.style.margin = ""),
                        te)
                ...
                qt !== x && (qt ? Xe ? E(Xe) : (Ke && E(Ke),
                Je && E(Je)) : Xe ? T(Xe) : (Ke && T(Ke),
                Je && T(Je))),
                jt !== b && (jt ? (E($e),
                _i()) : T($e)),
                ...
                i) {
                    ...
                    qt && Ft !== H && (Ke.innerHTML = Ft[0],
                    Je.innerHTML = Ft[1]),
                    mn && Yt !== R) {
                        var W = Qt ? 1 : 0
                          , q = mn.innerHTML
                          , F = q.length - R[W].length;
                        q.substring(F) === R[W] && (mn.innerHTML = q.substring(0, F) + Yt[W])
                    }
                } else
                    Ht && (Nt || At) && (r = !0);
                if ((u || Nt && !At) && (en = Ui(),
                _i()),
                (o = se !== L) ? (ge.emit("indexChanged", Zi()),
                r = !0) : u ? o || di() : (Nt || At) && (oi(),
                mi(),
                ii()),
                u && !Z && function() {
                    for (var t = se + Math.min(ht, Ot), e = ee; e--; ) {
                        var n = pt[e];
                        se <= e && e < t ? (m(n, "tns-moving"),
                        n.style.left = 100 * (e - se) / Ot + "%",
                        m(n, nt),
                        y(n, rt)) : n.style.left && (n.style.left = "",
                        m(n, rt),
                        y(n, nt)),
                        y(n, it)
                    }
                ...
                !we && !Te) {
                    if (i && !z && (Lt === P && Bt === I || (ct.style.cssText = Pn(Lt, Bt, Nt, It, Wt)),
                    lt)) {
        ...
        function _n() {
            if (!Nt && !At)
                return ht <= (Ht ? Ot - (Ot - 1) / 2 : Ot);
            var t = Nt ? (Nt + Bt) * ht : gt[ht]
              , e = Lt ? St + 2 * Lt : St + Bt;
            return Ht && (e -= Nt ? (St - Nt) / 2 : (St - (gt[se + 1] - gt[se] - Bt)) / 2),
            t <= e
        }
        function Zn() {
            for (var t in ut = 0,
            U)
                (t = parseInt(t)) <= mt && (ut = t)
        }
        function $n() {
            !Qt && mn && T(mn),
            !jt && $e && T($e),
        ...
        function ri(t) {
            null == t && (t = Ei());
            var e, n, i, a = se;
            if (Ht || Lt ? (At || Nt) && (n = -(parseFloat(t) + Lt),
            i = n + St + 2 * Lt) : At && (n = gt[se],
            i = n + St),
            At)
                gt.forEach((function(t, r) {
                    r < ee && ((Ht || Lt) && t <= n + .5 && (a = r),
                    .5 <= i - t && (e = r))
                }
                ));
            else {
                if (Nt) {
                    var r = Nt + Bt;
                    Ht || Lt ? (a = Math.floor(n / r),
                    e = Math.ceil(i / r - 1)) : e = a + Math.ceil(St / r) - 1
                } else if (Ht || Lt) {
                    var o = Ot - 1;
                    if (Ht ? (a -= o / 2,
                    e = se + o / 2) : e = se + o,
        ...
        function mi() {
            var t = ri()
              ...
              , n = t[1];
            v(pt, (function(t, i) {
                e <= i && i <= n ? g(t, "aria-hidden") && (C(t, ["aria-hidden", "tabindex"]),
                m(t, We)) : g(t, "aria-hidden") || (w(t, {
                    "aria-hidden": "true",
                    tabindex: "-1"
                }),
                y(t, We))
        ...
        function Mi(t) {
            return null == t && (t = se),
            At ? (St - (Lt ? Bt : 0) - (gt[t + 1] - gt[t] - Bt)) / 2 : Nt ? (St - Nt) / 2 : (Ot - 1) / 2
        }
        function Ti() {
            var t = St + (Lt ? Bt : 0) - (Nt ? (Nt + Bt) * ee : gt[ee]);
            return Ht && !zt && (t = Nt ? -(Nt + Bt) * (ee - 1) - Mi() : Mi(ee - 1) - gt[ee - 1]),
            0 < t && (t = 0),
            t
        }
        function Ei(t) {
        ...
        function Bi(t, e) {
            ae && En(),
            (se !== ce || e) && (ge.emit("indexChanged", Zi()),
        ...
        function Hi(t) {
            if (Z || me) {
                ...
                if (!t || !Z && t.target.parentNode === ft || t.target === ft && Si(t.propertyName) === Si(re)) {
                    if (!ae) {
                        var i = se;
                        En(),
                        se !== i && (ge.emit("indexChanged", Zi()),
                        Ai())
                    }
                    "inner" === _ && ge.emit("innerLoaded", Zi()),
                    me = !1,
        ...
        function Oi(t, e) {
            if (!Te)
                if ("prev" === t)
                    ...
                    var n = Sn()
                      , i = 0;
                    if ("first" === t ? i = -n : "last" === t ? i = Z ? ht - Ot - n : ht - 1 - n : ("number" != typeof t && (t = parseInt(t)),
        ...
        function Di(t, e) {
            ...
            if (Pt) {
                if (se === fe && -1 === e)
                    return void Oi("last", t);
                if (se === de && 1 === e)
                    return void Oi("first", t)
            }
            e && (se += Dt * e,
            At && (se = Math.floor(se)),
        ...
        function Qi() {
            ...
            i = !1,
            90 - (n = pe) <= (a = Math.abs(90 - Math.abs(e))) ? i = "horizontal" : a <= n && (i = "vertical"),
            i === t.axis;
            var e, n, i, a, r, o
        }
        function Xi(t) {
            ...
            Cn.x = wn.x = e.clientX,
            Cn.y = wn.y = e.clientY,
            Z && (xn = parseFloat(ft.style[re].replace(oe, "")),
            Ci(ft, "0s"))
        }
        function Yi(t) {
            if (Mn) {
                    ...
                    !function t(n) {
                        if (he) {
                            ...
                            he) {
                                !Ve && Vi(n) && (Ve = !0);
                                try {
                                    n.type && ge.emit(Vi(n) ? "touchMove" : "dragMove", Zi(n))
                                } catch (t) {}
                                var a = xn
                                  , r = Tn(Cn, wn);
                                if (!lt || Nt || At)
                                    ...
                                    a += W ? r * Ot * 100 / ((St + Bt) * ee) : 100 * r / (St + Bt),
                                    a += "%";
                                ft.style[re] = oe + a + ue
                            }
                        } else
            ...
            if (Mn) {
                ...
                if (Math.abs(r)) {
                    ...
                    Z ? bn = e((function() {
                        ...
                        Bi(n, r),
                        ge.emit(Vi(n) ? "touchEnd" : "dragEnd", Zi(n))
                    }
                    )) : he && Di(n, 0 < r ? -1 : 1)
                }
            }
